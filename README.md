<p align="center">
  ...
  <a href="https://jwt.io/" target="_blank">
   ...
   &nbsp;&nbsp;&nbsp;
  <a href="https://jwt.io/" target="_blank">
    <img src="https://avatars.githubusercontent.com/u/305935241?s=400&u=e626fdd2d8a7a9c54f907527a21d1dafc588eb3d&v=4" width="120" alt="JWT Logo" />
  </a>
</p>
...
```bash
git clone https://github.com/Salazar-Ingenieria/salazar-auth-access-api.git
```
...
| ---------------------------------- | ------------------------- | ------ | ------------------------------------------------------------------------------- |
| Iniciar sesión                     | `/authentication/sign-in` | POST   | `{ "email": "correo@ejemplo.com", "password": "123456789" }`                    |
| Crear cuenta                       | `/authentication/sign-up` | POST   | `{ "name": "usuario", "email": "correo@ejemplo.com", "password": "123456789" }` |
| Actualizar estado                  | `/users/:id`              | PUT    | _Ninguno_                                                                       |
| Actualizar perfil                  | `/users/:id`              | PATCH  | `{ "name": "usuario", "email": "correo@ejemplo.com", "password": "123456789" }` |
| Registrar Rol                      | `/roles`                  | POST   | `{ "name": "client" }`                                                          |
| Asignar permiso a usuario por ruta | `/access-user`            | POST   | `{ "user_id": 3, "routes_back": "/person", menu_id: 1}`                         |
| Asignar permiso al rol             | `/access-roles`           | POST   | `{ "rol_id": 3, "routes_back": "/person", menu_id: 1 }`                         |
